...
namespace {
    ...
    jobject new_import_result(JNIEnv *env, bool success, jlong term_count, jlong meta_count,
                              jlong media_count) {
        jclass cls = env->FindClass("com/hoshi/reader/core/dictionary/ImportResult");
    ...
    jobjectArray
    new_trace_array(JNIEnv *env, const std::vector<TransformGroup> &trace) {
        jclass cls = env->FindClass("java/lang/String");
        jobjectArray array = env->NewObjectArray(static_cast<jsize>(trace.size()), cls, nullptr);
        for (size_t i = 0; i < trace.size(); ++i) {
            jobject item = new_string(env, trace[i].name);
    ...
    jobject new_glossary_entry(JNIEnv *env, const GlossaryEntry &entry) {
        jclass cls = env->FindClass("com/hoshi/reader/core/dictionary/GlossaryEntry");
        jmethodID ctor =
    ...
    jobject new_frequency(JNIEnv *env, const Frequency &frequency) {
        jclass cls = env->FindClass("com/hoshi/reader/core/dictionary/Frequency");
    ...
    jobject new_frequency_entry(JNIEnv *env, const FrequencyEntry &entry) {
        jclass cls = env->FindClass("com/hoshi/reader/core/dictionary/FrequencyEntry");
        jmethodID ctor = env->GetMethodID(cls, "<init>",
                                          "(Ljava/lang/String;[Lcom/hoshi/reader/core/dictionary/Frequency;)V");
        jstring dict_name = new_string(env, entry.dict_name);
    ...
    jobject new_pitch_entry(JNIEnv *env, const PitchEntry &entry) {
        jclass cls = env->FindClass("com/hoshi/reader/core/dictionary/PitchEntry");
    ...
    jobject new_term_result(JNIEnv *env, const TermResult &term) {
        jclass cls = env->FindClass("com/hoshi/reader/core/dictionary/TermResult");
        jmethodID ctor = env->GetMethodID(cls, "<init>",
                                          "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Lcom/hoshi/reader/core/dictionary/GlossaryEntry;[Lcom/hoshi/reader/core/dictionary/FrequencyEntry;[Lcom/hoshi/reader/core/dictionary/PitchEntry;)V");
    ...
    jobject new_lookup_result(JNIEnv *env, const LookupResult &result) {
        jclass cls = env->FindClass("com/hoshi/reader/core/dictionary/LookupResult");
        jmethodID ctor = env->GetMethodID(cls, "<init>",
                                          "(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Lcom/hoshi/reader/core/dictionary/TermResult;I)V");
        jstring matched = new_string(env, result.matched);
        jstring deinflected = new_string(env, result.deinflected);
        jobjectArray process = new_trace_array(env, result.trace);
    ...
    jobject new_dictionary_style(JNIEnv *env, const DictionaryStyle &style) {
        jclass cls = env->FindClass("com/hoshi/reader/core/dictionary/DictionaryStyle");
...
Java_com_hoshi_reader_core_dictionary_HoshiDicts_createLookupObject(JNIEnv *, jobject) {
    return reinterpret_cast<jlong>(new LookupObject());
}

extern "C" JNIEXPORT void JNICALL
Java_com_hoshi_reader_core_dictionary_HoshiDicts_destroyLookupObject(JNIEnv *, jobject, jlong session) {
    delete as_object(session);
}

extern "C" JNIEXPORT void JNICALL
Java_com_hoshi_reader_core_dictionary_HoshiDicts_rebuildQuery(JNIEnv *env, jobject, jlong session,
...
Java_com_hoshi_reader_core_dictionary_HoshiDicts_importDictionary(JNIEnv *env, jobject, jstring zip_path,
                                                  jstring output_dir) {
...
Java_com_hoshi_reader_core_dictionary_HoshiDicts_lookup(JNIEnv *env, jobject, jlong session, jstring text,
                                        jint max_results) {
    LookupObject *obj = as_object(session);
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_hoshi_reader_core_dictionary_HoshiDicts_getStyles(JNIEnv *env, jobject, jlong session) {
    LookupObject *obj = as_object(session);
...
Java_com_hoshi_reader_core_dictionary_HoshiDicts_getMediaFile(JNIEnv *env, jobject, jlong session,
